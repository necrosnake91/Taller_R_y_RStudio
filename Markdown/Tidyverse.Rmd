...
<h1 class ="header">1 Tidyverse</h1>
...
`r fa("triangle-exclamation", fill = "#f9c80e")` Solo necesitas instalar una sola vez el paquete de tidyverse. Cada vez que inicies una nueva sesión en RStudio, no es necesario que lo vuelvas a instalar.
</div>

<h1 class="header">2 Tibble</h1>
...
```{r, include=T, echo=F}
#Genera un tibble de manera similar al dataframe
knitr::kable(tibble(Aerolinea = c("Aeromexico", "KLM", "Lufthansa", "Avianca"), Pais = c("Mexico", "Paises Bajos", "Alemania", "Colombia"), Vuelos_anuales = c(300, 1200, 1500, 200), Pista = 23))
```
...
<h2><font color="#6F7479">3.1</font> Select</h2>
...
* 2. Selecciona las columnas relacionadas con el **color de cabello, color de ojos, año de nacimiento y sexo** 
* 3. Selecciona las todas columnas excepto las que se asocian con **la altura, masa y la especie** 
* 4. Relocaliza la columna de la especie entre la masa y el color de cabello
</blockquote>

<h2><font color="#6F7479">3.2</font> Filter</h2>
...
`r fa("circle-info", fill="#182fdc")` Recuerda hacer uso de los operadores relacionales **==, !=, >, <, >=, <=** y de los nexos **| y &** para comparar multiples condiciones
</blockquote>
...
<h2><font color="#6F7479">3.3</font> Mutate</h2>
...
<h2><font color="#6F7479">3.4</font> Arrange</h2>
...
<blockquote class="hint">
`r fa("circle-info", fill="#182fdc")` La opción `desc()` es equivalente a `decreasing = ` de la función `sort()`
</blockquote>
...
<h2><font color="#6F7479">4.1</font> Drop_na, fill y replace_na</h2>
