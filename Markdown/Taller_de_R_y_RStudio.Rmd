...
<div class="alert alert-warning">Para realizar esta práctica es necesario que tengas instalado [R](https://cran.itam.mx/) y [RStudio](https://posit.co/download/rstudio-desktop/) o bien generes una cuenta en [Positcloud](https://login.posit.cloud/login?redirect=%2F) para hacer uso de la nube.
</div>
...
```{r, fig.align='center', out.width="700", echo=FALSE}
...
<h2>Los comandos paste() y paste0()</h2>
...
```{r}
##De manera similar a la función paste(), debes de separar los valores con comas
...
<h2>Propiedades de los vectores</h2>
...
<h2>Creación de vectores con secuencias o elementos repetidos</h2>
...
<h2>Manipulación de vectores</h2>
...
<h2>Propiedades de las matrices</h2>
...
<h2>Manipulación de matrices</h2>
...
<h2>Propiedades de los data frames</h2>
...
<h2>Manipulación de los data frames</h2>
...
<h2>Funciones sobre elementos de las listas</h2>
